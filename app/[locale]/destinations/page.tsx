...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: alternates(loc, "/destinations"),
    openGraph: { images: ogImages(undefined, dict.destinationsIndex.heading) },
    twitter: { card: "summary_large_image", images: ogImages(undefined, dict.destinationsIndex.heading) },
  };
}
...
export default async function DestinationsIndexPage({
  ...
  return (
    <main className="mx-auto max-w-6xl px-5 py-12">
      ...
      <p className="mt-3 text-muted">{dict.destinationsIndex.intro}</p>
